...
# Exécuter 'node scripts/characters_scraper.cjs'
logger.info("Exécution de 'node scripts/characters_scraper.cjs'...")
run_command("node scripts/characters_scraper.cjs")

# Exécuter 'node scripts/info_scraper.cjs'
logger.info("Exécution de 'node scripts/info_scraper.cjs'...")
run_command("node scripts/info_scraper.cjs")
